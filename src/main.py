...
def main():
    client_auth()
    startDate = '2023-11-01'  # future startDate gotten from stored data
    ...
    for Id in activityIds:
        ...
        # all sets are overwritten with the last set
        ...
        logging.debug(f"Workout data: datetime: {a_workout.datetime} Num of sets: {len(a_workout.sets)}")
        logging.debug(f"Num of workouts: {len(totalWorkouts)} activityID: {a_workout.activityId}")
